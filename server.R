...
if(getRversion() >= "2.15.1") utils::globalVariables(c('ada_model','gg_pr_Curve','gg_Cumulative_curve','gg_roc_curve','gg_lift_curve'))
...
shinyServer(function(input, output) {
  ...
  output$summary <- renderPrint({
    ...
    ada_model <<- AdaBoostM1(yuqi~.,data = train_data,na.action = na.pass,control = Weka_control(I=input$ntree))
  ...
  output$pr_curve <- renderPlot({
    ...
    n1 <- NCOL(train_data)
    preds <- predict(ada_model,test_data[,1:(n1-1)],type="probability")
    ## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ## predictions,labels
    ## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
